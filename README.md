...
The project was previously distributed under the MIT License. That copyright
and permission notice is preserved in [LICENSE-MIT](LICENSE-MIT) for the
historical MIT-licensed work.
