...
* added badges in readme by [@arkanoider](https://github.com/arkanoider)
* show both sides of the conversation

### 💼 Other


* feat(chat): show both sides of the conversation by [@arkanoider](https://github.com/arkanoider) in [#199](https://github.com/MostroP2P/mostro-cli/pull/199)

### 📚 Documentation


* describe getdmuser as a two-sided transcript by [@arkanoider](https://github.com/arkanoider)

## Contributors
* [@arkanoider](https://github.com/arkanoider) made their contribution
* [@](https://github.com/) made their contribution

**Full Changelog**: https://github.com/MostroP2P/mostro-cli/compare/v0.16.2...0.16.3
