...
## What's Changed in 0.15.3

### 🚀 Features


* implement AddBondInvoice action by [@grunch](https://github.com/grunch)

### 🐛 Bug Fixes


* pin newest info event and require a bolt11 reply by [@grunch](https://github.com/grunch)
* only treat wait timeout as a successful submission by [@grunch](https://github.com/grunch)

### 💼 Other


* feat(add-bond-invoice): implement AddBondInvoice action by [@grunch](https://github.com/grunch) in [#169](https://github.com/MostroP2P/mostro-cli/pull/169)

### 📚 Documentation


* use short flags in the reply hint by [@grunch](https://github.com/grunch)

## Contributors
* [@grunch](https://github.com/grunch) made their contribution in [#169](https://github.com/MostroP2P/mostro-cli/pull/169)

**Full Changelog**: https://github.com/MostroP2P/mostro-cli/compare/v0.15.2...0.15.3
